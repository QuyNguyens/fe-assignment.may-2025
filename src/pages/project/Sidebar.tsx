...
const Sidebar = () => {
  return (
    <div className="w-[218px] p-3 min-h-screen bg-gray-50 flex flex-col gap-8">
        ...
        <div className='h-full flex flex-col justify-between'>
            <div className='flex flex-col gap-2'>
                <IconText icon={OverViewIcon} iconHover={OverViewIconHover} text='Overview'/>
                <IconText icon={InquiresIcon} iconHover={InquiresIconHover} text='Inquiries'/>
                <IconText icon={EstimatorIcon} iconHover={EstimatorIconHover} text='Estimator'/>
                <IconText icon={ProjectsIcon} iconHover={ProjectsIconHover} text='Projects'/>
            </div>
            <div className='flex flex-col gap-2'>
                <IconText icon={AdministrationsIcon} iconHover={AdministrationsIconHover} text='Administrations'/>
                <IconText icon={DocumentationIcon} iconHover={DocumentationIconHover} text='Documentation'/>
